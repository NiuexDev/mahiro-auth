// @ts-nocheck
import { build, type SameShape, type BuildOptions } from "esbuild"
import { name, version, dependencies } from "./package.json" assert { type: "json" }
...
const esbuildConfig: SameShape<BuildOptions, T> = {
