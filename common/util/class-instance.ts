...
Object.defineProperty(Function.prototype, 'isDirectSubclass', {
    value: function (this: AnyClass, potentialChild: any): boolean {
        // 必须是函数才能有原型继承关系
...
Object.defineProperty(Function.prototype, 'isSubclass', {
    value: function (this: AnyClass, potentialDescendant: any): boolean {
...
Object.defineProperty(Function.prototype, 'isDirectInstance', {
    value: function (this: AnyClass, potentialInstance: any): boolean {
